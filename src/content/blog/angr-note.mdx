...
pubDate: "May 10 2025"
image: /image/blog-cover/angr-note.jpg
categories:
  - tech
tags:
  - Reverse
...
When loading the bianry into IDA, you can notice that the program is really short. 
...
## 15_angr_arbitrary_read (Update soon)

## 16_angr_arbitrary_write (Update soon)

## 17_angr_arbitrary_jump (Update soon)